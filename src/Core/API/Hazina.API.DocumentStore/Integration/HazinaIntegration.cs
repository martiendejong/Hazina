...
namespace Hazina.API.DocumentStore.Integration;
...
public class HazinaStoreFactory : IHazinaStoreFactory
{
    ...
    public HazinaStoreInstance CreateStore(HazinaStoreConfig config)
    {
        ...
        // Create DocumentStore (fully qualified to avoid namespace collision)
        var documentStore = new global::DocumentStore(
            textEmbeddingStore,
            textStore,
            chunkStore,
            metadataStore,
