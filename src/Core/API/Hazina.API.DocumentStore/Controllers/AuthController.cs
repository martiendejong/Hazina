...
/// This controller keeps IConfiguration because JWT secrets are host-specific.
/// </summary>
[ApiController]
[Route("api/v1/auth")]
public class AuthController : ControllerBase
{
    ...
    private string GenerateJwtToken(string userId)
    {
        ...
        var issuer = jwtSettings["Issuer"] ?? "Hazina.API.DocumentStore";
        var audience = jwtSettings["Audience"] ?? "Hazina.API.DocumentStore.Clients";
