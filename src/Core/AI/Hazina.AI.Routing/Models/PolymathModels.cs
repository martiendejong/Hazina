...
{
    /// <summary>Use an LLM to identify consensus across agent responses.</summary>
    Consensus,

    /// <summary>Select the single best response (longest/most thorough).</summary>
    Best,

    /// <summary>Use an LLM to merge all agent findings into one comprehensive response.</summary>
    Merge
}
...
public class PolymathResult
{
    ...
    /// <summary>Total input tokens across all agents.</summary>
