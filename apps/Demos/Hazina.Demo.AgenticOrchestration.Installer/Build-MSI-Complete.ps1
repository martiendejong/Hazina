...
[void]$sb.AppendLine('           Version="2.2.0"')
...
[void]$sb.AppendLine('                  Return="ignore" />')
[void]$sb.AppendLine('')
[void]$sb.AppendLine('    <!-- Custom action to update credentials -->')
...
[void]$sb.AppendLine('')
[void]$sb.AppendLine('    <!-- Custom UI: credentials dialog + navigation overrides -->')
[void]$sb.AppendLine('    <UI>')
[void]$sb.AppendLine('      <!-- Custom credentials dialog -->')
...
[void]$sb.AppendLine('        <Control Id="ErrorText" Type="Text" X="20" Y="260" Width="330" Height="20" NoPrefix="yes" Text="{\WixUI_Font_Normal_Red}Passwords do not match!" Hidden="yes">')
...
[void]$sb.AppendLine('')
[void]$sb.AppendLine('      <!-- Override InstallDirDlg Next button to go to CredentialsDlg -->')
