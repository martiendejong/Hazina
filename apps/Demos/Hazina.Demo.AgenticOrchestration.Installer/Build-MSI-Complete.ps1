...
[void]$sb.AppendLine('')
[void]$sb.AppendLine('    <!-- Custom action to set file permissions for regular users (immediate - runs with elevated privileges inherited from MSI) -->')
[void]$sb.AppendLine('    <!-- Step 1: Set CustomActionData with install folder path (immediate) -->')
[void]$sb.AppendLine('    <CustomAction Id="SetFilePermissions_Cmd"')
[void]$sb.AppendLine('                  Property="SetFilePermissions"')
[void]$sb.AppendLine('                  Value="&quot;[INSTALLFOLDER]&quot;"')
[void]$sb.AppendLine('                  Execute="immediate" />')
[void]$sb.AppendLine('    <!-- Step 2: Execute PowerShell script (deferred with elevation) -->')
[void]$sb.AppendLine('    <CustomAction Id="SetFilePermissions"')
[void]$sb.AppendLine('                  Directory="INSTALLFOLDER"')
[void]$sb.AppendLine('                  ExeCommand="powershell.exe -ExecutionPolicy Bypass -File &quot;[INSTALLFOLDER]SetFilePermissions.ps1&quot;"')
...
[void]$sb.AppendLine('      <Custom Action="SetFilePermissions_Cmd" Before="InstallFinalize">1</Custom>')
[void]$sb.AppendLine('      <Custom Action="SetFilePermissions" After="SetFilePermissions_Cmd">1</Custom>')
[void]$sb.AppendLine('    </InstallExecuteSequence>')
[void]$sb.AppendLine('')
