...
[void]$sb.AppendLine('    <Property Id="POWERSHELL_PERMS" Value="powershell.exe" />')
[void]$sb.AppendLine('    <CustomAction Id="SetFilePermissions"')
[void]$sb.AppendLine('                  Property="POWERSHELL_PERMS"')
[void]$sb.AppendLine('                  ExeCommand="-ExecutionPolicy Bypass -File &quot;[INSTALLFOLDER]SetFilePermissions.ps1&quot; -InstallDir &quot;[INSTALLFOLDER]&quot;"')
[void]$sb.AppendLine('                  Execute="immediate"')
[void]$sb.AppendLine('                  Return="check" />')
[void]$sb.AppendLine('')
...
[void]$sb.AppendLine('      <Custom Action="SetFilePermissions" After="InstallFiles">NOT Installed</Custom>')
[void]$sb.AppendLine('    </InstallExecuteSequence>')
[void]$sb.AppendLine('')
