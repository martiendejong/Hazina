...
[void]$sb.AppendLine('    <Property Id="AUTH_PASSWORD" Secure="yes" Value="<REDACTED:rotated-2026-07-18-see-vault>" />')
[void]$sb.AppendLine('    <Property Id="AUTH_PASSWORD_CONFIRM" Secure="yes" Value="<REDACTED:rotated-2026-07-18-see-vault>" />')
